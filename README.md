...
- "describe" breaks your test suite into components and "it" is where you perform individual tests.

2. What is the point of `Test Driven Development`? What do you think about this approach?

- The point of test driven development is to understand from a user standpoint how your application is functioning and how you expect it to behave. It takes some adjusting, but I like this approach because it makes sure that your application doesn't throw you any unexpected bugs that can mess up the functionality of the application down the road.

3. Mention three types of automated tests.

- Unit testing, API testing, and UI testing
